...
if __name__ == '__main__':
    while (True):
        ...
        if option == 1:                                             # Redirige l'utilisateur en fonction de son choix
            exec(open("TP1/TP1.1.py").read())
        elif option == 2:
            exec(open("TP1/TP1.2.py").read())
        elif option == 3:
            exec(open("TP1/TP1.3.py").read())
        elif option == 4:
            exec(open("TP1/TP1.4.py").read())
        elif option == 5:
            exec(open("TP1/TP1.5.py").read())
        elif option == 6:
            exec(open("TP1/TP1.6.py").read())
        elif option == 7:
            exec(open("TP1/TP1.7.py").read())
        elif option == 8:
